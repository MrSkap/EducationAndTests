...
public class DetectCrossoverPipeline : IPipelineBehavior<CarIdentificationContext, CarIdentificationResult>
{
    private readonly ILogger _logger = Log.ForContext<DetectCrossoverPipeline>();
    private const CarModelType Type = CarModelType.Crossover;
